        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              An AI-powered Learning Management System built with Next.js 16. 
              Empowering educators to create courses and learners to track their progress.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/courses" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">
                  Browse Courses
                </Link>
              </li>
              <li>
                <Link href="/register" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">
                  Get Started
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/PranjalBarnwal"
                target="_blank"
            ...
            <p className="text-xs text-gray-500">
              Built with <Heart className="h-3 w-3 inline text-red-500 fill-red-500" /> by Pranjal Barnwal
            </p>
          </div>
        </div>
