...
import { User, Mail, Lock, Sparkles, GraduationCap, BookOpen } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              disabled={isLoading}
            >
              <SelectTrigger className="h-10 border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm">
                <div className="flex items-center gap-2">
                  {formData.role === 'LEARNER' ? (
                    <>
                      <BookOpen className="h-3.5 w-3.5 text-blue-600" />
                      <span>Learn - Access courses</span>
                    </>
                  ) : (
                    <>
                      <GraduationCap className="h-3.5 w-3.5 text-purple-600" />
                      <span>Teach - Create courses</span>
                    </>
                  )}
                </div>
              </SelectTrigger>
              <SelectContent className="min-w-[250px]">
                <SelectItem value="LEARNER">
                  <div className="flex items-center gap-2">
                    <BookOpen className="h-3.5 w-3.5 text-blue-600" />
                    <span className="text-sm">Learn - Access courses</span>
                  </div>
                </SelectItem>
                <SelectItem value="EDUCATOR">
                  <div className="flex items-center gap-2">
                    <GraduationCap className="h-3.5 w-3.5 text-purple-600" />
                    <span className="text-sm">Teach - Create courses</span>
                  </div>
                </SelectItem>
              </SelectContent>
            </Select>
